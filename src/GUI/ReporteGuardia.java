 ...
 * @author Dickson
 */
public class ReporteGuardia extends javax.swing.JFrame {
    private DefaultTableModel model;

    /**
     * Creates new form ListadoGuardias
     */
    public ReporteGuardia() {
        this.setTitle("Animales Por Guardia");
        ...
        String data[][] = {};
        String col[] = {"Nombre","Id","Id Categoria","Categoria"};
    ...
    private void initComponents() {
        ...
        guardiaCombo = new javax.swing.JComboBox();
        ...
        guardiaCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                guardiaComboActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("Reporte Por Guardia");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addComponent(guardiaCombo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(236, 236, 236)
    ...
    private void guardiaComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardiaComboActionPerformed
     
        limpiarJTable();
        String seleccionGuardia = (String)guardiaCombo.getSelectedItem();
        java.util.StringTokenizer st = new java.util.StringTokenizer(seleccionGuardia, " - ");
        String guardia = st.nextToken();
        ...
        while (p != null)
        {
            if (p.getCedulaGuardia().equals(guardia))//compara cedula de guardia de la jaula con la ya seleccionada enel jframe
            {
    ...
    }//GEN-LAST:event_guardiaComboActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String cadena="Nombre \t Id \t Id Categoria \t Categoria \t Cedula Guardia \n";
        ...
        while (p != null)
        {
            if (p.getCedulaGuardia().equals(guardia))
            {
                for (int h=0; h<p.listaA.size(); h++)
                {
                    Animal a = null;
                    ...
                    cadena+= a.getNombreAnimal()+ "\t" + a.getIdAnimal()+"\t"+a.getCategoria()+
                            "\t"+a.getNombreCategoria()+ "\t" + p.getCedulaGuardia() + "\n";
                }
            }
            p = p.sig;
        }

        Archivo.crear_archivo("Listado Animales Por Guardia.xls", cadena);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteGuardia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static javax.swing.JComboBox guardiaCombo;
